...
import java.util.concurrent.locks.ReentrantLock;
    ...
    public TicketSystem(int availableTickets) {
    ...
    private TicketSystem bookingSystem;
    private int numTickets;
    private String threadName;

    public BookingThread(TicketSystem bookingSystem, int numTickets, String threadName) {
